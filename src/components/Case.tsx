...
export default function Case({ title, description}: { title: string, description: string,}) {
    return (
        <div className="bg-beige relative">
            <section className="relative flex flex-col lg:flex-row lg:items-center justify-evenly text-center lg:h-[70svh] lg:pt-52 pt-20 h-[90svh] px-7" id="banner">
                ...
                <div className="text-left text-xl lg:max-w-[500px] z-10">
